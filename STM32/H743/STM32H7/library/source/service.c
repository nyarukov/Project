...
/**
*@brief 该函数获取标志字符串表示形式。
*
*@param flags 标志代码。
*
*@return 指向标志字符串的指针。
*
*@note 该函数返回一个指向静态字符串的指针，并在每次调用时覆盖缓冲区。
*/
...
*@brief 该函数为环形缓冲区分配内存。
*
*@paramringbuf 要分配的环形缓冲区。
*@param size 内存的大小。
*
*@return MR_ERR_OK 成功，否则返回错误代码。
*/
